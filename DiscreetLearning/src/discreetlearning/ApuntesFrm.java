...
import static discreetlearning.ClaseFrm.status;
 ...
 * @author Camila
 */
public class ApuntesFrm extends javax.swing.JFrame {
    ...
    public ApuntesFrm(String user) {
        initComponents();
        jTextArea1.setLineWrap(true);
        status = Dlearning.dlv();
        this.user = user;
        change = "esta_en_asesorias";
        band = true;
    ...
    public void Step(){
        ...
        try{
            switch(status){
                case "ir_asesorias(primero);": content = Files.readAllLines(Paths.get("src/Files/ConceptosRelaciones.txt"));
                                                  lit = content.listIterator();
                                                  jTextArea1.append(content.get(cont));
                                                  while(lit.hasNext()){
                                                    jTextArea1.append(lit.next());
                                                  }
                                                  break;
                                                  
                case "ir_asesorias(segundo);": break;
                case "ir_asesorias(tercero);": break;
 ...
 regenerated by the Form Editor.
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/discreetlearning/newpackage/Finalizarbutton.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //Actualizar el plan sin la accion ya realizada
            ...
            band = false;
            Update.updatePlan(change, band);
            change = "necesita_asesorias(primero)";
            band = false;
            Update.updatePlan(change, band);
            status = Dlearning.dlv();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApuntesFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApuntesFrm(user).setVisible(true);
            }
        });
    }
